...
class Perceptron(object):
    ...
    def predict(self, X):
        # This is a temporary predict function so that the distribution code runs.
        # You should define the "predict" methods for KernelPerceptron
        # and BudgetKernelPerceptron to override this definition.
        return (X[:, 0] > .5)
