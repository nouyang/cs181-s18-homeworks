...
\begin{answer}
    ...
    \begin{table}[H]
        \centering
        \caption{K-Means l2 objective for different values of K}
        \label{my-label}
        \begin{tabular}{@{}lll@{}}
            \toprule
...
\begin{answer}
        The results do seem to vary noticeably between runs, aside from the K=2 case, which exhibits
        little variation. 
        The results do vary even more for different values of K; for K=10, the mean images will
        sometimes miss entire numbers, while for k=15 we will get repeats of a few of the values
