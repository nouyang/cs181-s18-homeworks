...
\begin{enumerate}
    ...
    $-\ln p(D ; \bpi)$.
        ...
        Let  $p(\bx|\by=C_k)$ denote
        the class-conditional density of features $\bx$ (in this
        case for class $C_k$). Consider the data set $D = \{(\bx_i,
        \by_i)\}_{i=1}^n$ where as above $\by_i \in \{C_k\}_{k=1}^c$ is
